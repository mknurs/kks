...
Govorico kritike hočemo soočiti z nekaterimi tovrstnimi
...
na nakupovalne arkade v obliki krožne Crystal Palace, ki naj
...
Sheffieldu ter Roobin Hood Gardens – deloval kot nukleus
...
Vse to pa nas je zopet pripeljalo k našemu začetnemu
...
Izpraznjeni znak je tudi instrument De Chiricove metafizike,
...
Gre za donesek temeljnega teoretskega pomena; sodobna
...
Zdi se, da hoče Aymoninov projekt poudariti vsako rešitev,
...
flâneur (postopač), ki si umišlja, da se lahko oprime nekega
...
nedvomno kritično vrednost, vendar pa to ni tista, ki jo
...
"pričakovanje". Njegovi znaki brez dvoma zahtevajo
...
V kakšni meri lahko ta konceptualna stališča primerjamo s
...
Toda kaj pomeni osamitev čiste *risbe*, ne zgolj in ne
...
govorice. Vendar pa *boudoir* novih velikih pisateljev
...
Schwittersovega Mevzbau, do konstruktivističnih slik
...
fizični prostor skušajo zapolniti z eksaltiranimi
...
Michel Foucault je pripomnil, da med načini rabe govorice
...
Vendar pa nas to prisili k temu, da skorajda scela odvržemo
...
je mesto nekega dela v produkcijskih odnosih – potem dobijo
...
"Odčarana avantgarda", ki v svojih gracioznih boudairs skuša
...
[^4]: Mislimo na dvorano "à la Melnikov", ki je obešena na
  transverzalnih pilastrih, pri stavbi univerze v Leicestru
...
[^17]: Alda Rossija obravnavamo tu le kot arhitekta.
  ...
  Aldo Rossi, Milano, 1975, z izčrpno bibliografijo;
...
[^21]: Revija Parametro, št. 21–22, 1973, ki je posvečena
  ...
  napadajo zato, ker hočejo napasti Rossija – o njegovi
...
[^24]: Prim. Adolf Loos, Parole nel vuoto, Milano, 1972,
  ...
  Letter from Ludwig Wittgenstein With Memory by Paul
...
[^32]: Prim. Massimo Scolari, Les apories de l'architecture,
  ...
  akvarelov, ki jo je M. Gandelsonas izpeljal v članku
...
[^38]: M. Gandelsonas, On reading architecture, v
  ...
  Michael Graves, L'imagine e il suo doppio, str. 20–22 in
  naslednje, v eseju Les Bijoux indiscrits, katalog Five
  Architects, NY, Rim 1976.

    Mimogrede lahko pripomnimo, da morda tisto, kar je Argan
    prepoznal v arhitekturi Louisa Kahna, prej velja za ta
    tip raziskav. "Tisti tokovi, ki so danes najbolj
    angažirani, ki se najbolj zavedajo krize – piše Argan –
    izvajajo metodično, skorajda znanstveno in v vsakem
    primeru kritično analizo strukturnih komponent
    umetniškega "pojava": umetnost, ki se hoče ustaliti, se
    še zmeraj lahko "fenomenizira", tako da kritično
    raziskuje zakaj je neka površina površina, volumen
    volumen, zgradba zgradba, slika slika. Zato ker so
    spoznali, da se umetnost ne more opredeliti z njeno
    povezavo in funkcijo v sistemu, raziskujejo, če jo je
    mogoče opredeliti kot sistem po sebi, kot neko avtonomno
    strukturo." (Giulio Carlo Argan, I due stadi della
    critica, v monografski številki Ulisse, Dove va l'arte,
    november 1973, vol. XIII., št. 76, str. 14–26 (navedek
    je na strani 25)). O tej tematiki cf. tudi knjiga
    Filiberta Menne, La linea analitica dell'arte moderna.
    Le figure e le icone, Torino 1975.
[^39]: Cf. Walter Segal, The Neo-Purist School of
  Architecture, v Architectural Design, 1972, vol. XLII, št.
  6, str. 344–345.
[^40]: Tu mislimo tako na "Novo Arhitekturo" opredeljeno z
  velikim N in velikim A, ki pa ni dovolj tehtno
  opredeljena, v knjigi Nina Dardija, Il gioco sapiente,
  Padova 1971, kakor tudi na "Novo Tendenco" (glej stalno
  prisotnost velikih začetnic), ki jo je opredelil Massimo
  Scolari v Avanguardie e nuova architettura, nav. d. Če gre
  za opredelitev kontinuitete z abstraktnimi tendencami iz
  dvajsetih in tridesetih let, potem bi morali zbrati toliko
  poguma in govoriti prej o revival ali survival kot pa o
  "novem"; Če se že hoče poudariti primat jezikoslovnih
  obravnav, potem bi morali veliko bolj paziti, ko se
  nakazuje sorodnosti oziroma izjeme.
[^41]: Rudolf Arnheim, Entropia e arte. Saggio sul disordine
  e l'ordine, Torino 1974, str. 74–75, izv. izd. Entropy and
  Art. An Essay on Disorder and Order, University of
  California Press, 1971.
[^42]: Jean Arp, On my way. Poestry and essays 1912–1947,
  New York 1948, str. 77. Bleščeča analiza Arpove poetike je
  v knjigi Laure Mancinelli, Il messaggio razionale
  dell'avanguardia, Torino 1978.
[^43]: Cf, Bruno Zevi, Il linguaggio moderno
  dell'architettura. Guida al codice anticlassico, Torino
  1973.
[^44]: Cf. L'architecture d'aujourd'hui, 1973, št. 169, str.
  63–69.
[^45]: Michel Foucault, L'ordine dell discorso, Torino 1972,
  str. 19; iz. izd. L'ordre du discours, nastopno predavanje
  na Collège de France, 2. decembra 1970.
[^46]: O stališčih Hannesa Meyerja glej temeljni esej
  Francesca Dal Coja, ki je objavljen v italijanski izdaji
  spisov švicarskega arhitekta, z naslovom Architettura e
  rivoluzione, Padova 1973 (za nasprotno mnenje glej članek
  Massima Scolarija, Hannes Meyer e la pretesa negazione
  dell'arte, v Controspazio, I., 1969, št. 7, str. 58–59),
  ob znani monografiji Claude Schmidta. Cf. tudi Hans
  Schmidt, Beiträge zur Architektur, Berlin 1965, in
  številko Werka, 1972–10, ki je delno posvečena
  Schmidtovemu delu.
[^47]: Foucault, L'ordine del discorso, nav. d., str. 20.
[^48]: Jencks, Modern Movements in Architecture, nav. d.,
  str. 51–59 (pogl. Dolce vita or the Supersensualists).
[^49]: Med številnimi publikacijami o Arati Isozakiju je
  morda z antologijskega gledišča najbolj popolna japonska
  revija SD (Space Design), 1976m št. 140, s člankom Hansa
  Holleina, Position and More. The architect as a work of
  art, or Mr. Isozaki marries the fresh window, str. 4–9,
  člankom Kazuhiro Ishija, A Guide to the World of Arata
  Isozaki, str. 11–23, pa tudi 28 of Isozaki's works with
  notes by the architect himself, str. 24 in naslednje in
  Chronological Review, str. 179–188. Cf. tudi esej Kennetha
  Framptona, The Japanese New Wave, v katalogu A New Wave of
  Japanese Architecture, New York 1978, str. 2–13.
[^50]: Benjamin, Der Autor als Produzent (ital. prev.,
  Avangardia e rivoluzione, Torino 1973, str. 201). Ta
  Benjaminov esej navaja tudi Paolo Portoghesi, ko skuša
  spodbiti nekatere naše teze o funkciji arhitekturnih
  ideologij (cf. Paolo Portoghesi, Autopsia o vivisezione
  dell'architettura, v Controspazio, 1, november 1969, str.
  5–7). Benjamin je dejansko tudi tu dvoumen in se ponuja
  različnim interpretacijam. Toda napačno bi bilo, če bi se
  omejili, tako kot to počne Portoghesi, na tradicionalne
  aspekte teksta. Benjamin je, ko je predstavil šolo Neue
  Sachlichkeit, napisal: "Ta šola je razglasila lastno bedo.
  Na ta način se je izognila neizogibni nalogi današnjega
  književnika: da spozna, kako je *reven* in kako mora biti
  *reven*, če hoče začeti od začetka … Piscu, ki je zrelo
  premislil pogoje današnjega ustvarjanja, ni nič bolj tuje
  od pričakovanja ali zgolj hrepenenja po takšnih delih (gre
  za mojstrovine, ki se šopirijo z že zdavnaj ponarejeno
  ustvarjalno osebnostjo). Njegovo delo ne bo nikoli
  uperjeno k produktom, ampak vselej tudi k produkcijskim
  sredstvom. Z drugimi besedami: njegovi produkti morajo
  imeti ob in pred značajem dela – funkcijo organizacije"
  (str. 211, kurziv naš). Sam Benjamin opozarja, da se ta
  organizacijska funkcija ne sme omejiti na propagandne
  namene.
[^51]: Cf. Benjamin, Der Autor als Produzent, nav. d., str.
  208.
[^52]: Benjamin, Der Autor als Produzent, nav. d. (ital
  prev. nav. d., str. 216–217).
